...
def main():
    ...
    shadow_price_2030 = get_data(
        results, "all", "metrics", ["co2_shadow"], "B", "CO2 shadow price", "2030"
    )
    shadow_price_2050 = get_data(
        results, "all", "metrics", ["co2_shadow"], "C", "CO2 shadow price", "2050"
    )
    ...
    electricity_generation_share_2030 = calculate_share(
        results, "all", "supply_energy", ["AC", "generators"], "D", "C", "2030"
    )
    electricity_generation_share_2050 = calculate_share(
        results, "all", "supply_energy", ["AC", "generators"], "E", "C", "2050"
    )
    ...
    lowT_share_2030 = calculate_share(
        results, "all", "supply_energy", ["lowT industry", "links"], "D", "C", "2030"
    )
    lowT_share_2050 = calculate_share(
        results, "all", "supply_energy", ["lowT industry", "links"], "E", "C", "2050"
    )
    ...
    mediumT_share_2030 = calculate_share(
        results, "all", "supply_energy", ["mediumT industry", "links"], "D", "C", "2030"
    )
    mediumT_share_2050 = calculate_share(
        results, "all", "supply_energy", ["mediumT industry", "links"], "E", "C", "2050"
    )
    ...
    highT_share_2030 = calculate_share(
        results, "all", "supply_energy", ["highT industry", "links"], "D", "C", "2030"
    )
    highT_share_2050 = calculate_share(
        results, "all", "supply_energy", ["highT industry", "links"], "E", "C", "2050"
    )
    ...
    rural_heating_share_2030 = calculate_share(
        results, "all", "supply_energy", ["rural heat", "links"], "D", "C", "2030"
    )
    rural_heating_share_2050 = calculate_share(
        results, "all", "supply_energy", ["rural heat", "links"], "E", "C", "2050"
    )
